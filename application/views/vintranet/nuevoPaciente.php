<div class="" id="nuevopaciente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                  <form class="" action="index.html" method="post">
                        ...
                        <div class="modal-body">
                                  ...
                                  <div class="row" id="duplicado">
                                        <div class="col-lg-4" >
                                             ...
                                             <label for="" class="duplicate" id="duplicate" name="hhcc">Ya existe hhcc</label>
                                       </div> <!-- col-lg-3 -->
                                        <div class="col-lg-4">
                                              <div class="input-group "  id="input-dup" >
                                        ...
                                        <div class="col-lg-4">
                                              <div class="input-group " >
                                                    ...
                                                    <input  type= "text"  name="telefono" class= "form-control"  placeholder= "Tel&eacute;fono"  aria-describedby= "basic-addon1" required="required">
                                             </div>
                                       </div> <!-- col-lg-4 -->
                                  </div> <!-- row -->
                                  <div class="row">
                        ...
                        <div class="modal-footer">
                               <button type="submit" class="btn  btn-success" id="regPac">Registrar</button>
